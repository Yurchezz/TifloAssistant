...
import okio.Okio;
import ua.iot.lviv.client.auth.ApiKeyAuth;
import ua.iot.lviv.client.auth.Authentication;
import ua.iot.lviv.client.auth.HttpBasicAuth;
import ua.iot.lviv.client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://shazam-api.herokuapp.com/";
    ...
    private KeyStore readKeyStore() {
        ...
        char[] password = "fwefew".toCharArray();
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://shazam-api.herokuapp.com/
